var detailsDATA = {
  ...
  "y22wk02": [
    {
      "original-title": "ASSESSED VALUATION OF ALL TAXABLE PROPERTY OWNED BY GEORGIA NEGROES",
      "new-title": "REAL MONTHLY INCOME PER CAPITA OF BLACK HOUSEHOLDS IN BRAZIL",
      "packages": [
        ["dplyr"],
        ["ggforce"],
        ["ggplot2"],
  ...
  "y22wk03": [
    {
      "original-title": "RELATIVE NEGRO POPULATION OF THE STATES OF THE UNITED STATES",
      "new-title": "ACCESS OF BLACK PEOPLE TO A PERSONAL MOBILE PHONE AND INTERNET IN THE STATES OF BRAZIL",
      "packages": [
        ["dplyr"],
        ["ggplot2"],
        ["ggtext"],
  ...
  "y22wk04": [
    {
      "original-title": "VALUATION OF TOWN AND CITY PROPERTY OWNED BY GEORGIA NEGROES",
      "new-title": "REAL INCOME OF BLACK PEOPLE WHOSE MAIN WORK IS INFORMAL",
      "packages": [
        ["dplyr"],
        ["emojifont"],
        ["ggplot2"],
  ...
  "y22wk05": [
    {
      "original-title": "SLAVES AND FREE NEGROES",
      "new-title": "PARTICIPATION IN MANAGERIAL POSITIONS BY RACE IN BRAZIL",
      "packages": [
        ["dplyr"],
        ["ggplot2"],
        ["ggtext"],
  ...
  "y22wk06": [
    {
      "original-title": "ILLITERACY",
      "new-title": "ILLITERACY RATE OF BLACK PEOPLE IN BRAZIL",
      "packages": [
        ["dplyr"],
        ["ggforce"],
        ["ggplot2"],
  ...
  "y22wk07": [
    {
      "original-title": "CONJUGAL CONDITION OF AMERICAN NEGROES ACCORDING TO AGE PERIODS",
      "new-title": "CAPITAL OF CANDIDATURES FOR THE LOWER HOUSE OF THE BRAZILIAN CONGRESS BY RACE AND STATE",
      "packages": [
        ["dplyr"],
        ["ggplot2"],
        ["ggtext"],
  ...
  "y22wk08": [
    {
      "original-title": "ASSESSED VALUE OF HOUSEHOLD AND KITCHEN FURNITURE OWNED BY GEORGIA NEGROES",
      "new-title": "RATE OF HOMICIDES OF BLACKS BY PER 100K PEOPLE",
      "packages": [
        ["dplyr"],
        ["ggplot2"],
        ["ggtext"],
  ...
  "y22wk09": [
    {
      "original-title": "NUMBER OF NEGRO STUDENTS TAKING THE VARIOUS COURSES OF STUDY OFFERED IN GEORGIA SCHOOLS",
      "new-title": "OCCUPIED BLACKS PER 1000 PEOPLE BY EDUCATIONAL LEVEL IN BRAZIL",
      "packages": [
        ["dplyr"],
        ["ggforce"],
        ["ggplot2"],
  ...
  "y22wk10": [
    {
      "original-title": "PROPORTION OF TOTAL NEGRO CHILDREN OF SCHOOL AGE WHO ARE ENROLLED IN THE PUBLIC SCHOOLS",
      "new-title": "PROPORTION OF BLACKS AND NON-BLACKS CANDIDATES AND ELECTED FOR THE LOWER HOUSE OF THE BRAZILIAN CONGRESS",
      "packages": [
        ["dplyr"],
        ["ggtext"],
        ["glue"],
  ...
  "y23wk02": [
    {
      ...
      "new-title": "REAL AVERAGE INCOME OF BLACK BRAZILIANS",
      "packages": [
        ["dplyr"],
        ["ggforce"],
        ["ggplot2"],
  ...
  "y23wk03": [
    {
      "original-title": "CITY AND RURAL POPULATION 1890",
      "new-title": "HOMICIDE VICTIMS BY RACE AND SEX",
      "packages": [
        ["dplyr"],
        ["geomtextpath"],
        ["ggborderline"],
  ...
  "y23wk04": [
    {
      "original-title": "DISTRIBUTION OF NEGROES IN THE UNITED STATES",
      "new-title": "DISTRIBUTION OF BLACKS IN BRAZIL",
      "packages": [
        ["dplyr"],
        ["geobr"],
        ["ggbeeswarm"],
  ...
  "y23wk05": [
    {
      "original-title": "NEGRO BUSINESS MEN IN THE UNITED STATES",
      "new-title": "RIO SAMBA SCHOOLS PARADE WINNERS",
      "packages": [
        ["colorspace"],
        ["dplyr"],
        ["ggplot2"],
  ...
  "y23wk06": [
    {
      "original-title": "CRIME AMONG AMERICAN NEGROES",
      "new-title": "INCARCERATED PEOPLE BY RACE IN BRAZIL",
      "packages": [
        ["colorspace"],
        ["dplyr"],
        ["ggfx"],
  ...
  "y23wk07": [
    {
      "original-title": "OCCUPATIONS OF NEGROES AND WHITES IN GEORGIA",
      "new-title": "HIGHER EDUCATION ENROLLMENTS BY RACE AND FIELD",
      "packages": [
        ["dplyr"],
        ["ggforce"],
        ["ggplot2"],
  ...
  "y24wk03": [
    {
      "original-title": "ACRES OF LAND OWNED BY NEGROES IN GEORGIA",
      "new-title": "PERCENTAGE OF BLACKS IN EXTREME POVERTY",
      "packages": [
        ["dplyr"],
        ["forcats"],
        ["ggplot2"],
  ...
  "y24wk05": [
    {
      ...
      "new-title": "SAMBAS IN WHICH AFRO-BRAZILIAN TERMS APPEAR",
      "packages": [
        ["dplyr"],
        ["ggplot2"],
        ["ggtext"],
